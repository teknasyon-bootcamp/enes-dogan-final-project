        ...
        <ul class="list-unstyled ps-0">
            <li class="mb-1">
                ...
                <div class="collapse show" id="home-collapse">
                    <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                        <li><a href="{{route('admin.categories.create')}}" class="link-dark rounded">Create a New Category</a></li>
                        <li><a href="{{route('admin.categories.index')}}" class="link-dark rounded">Manage Categories</a></li>
                    </ul>
                </div>
            </li>
            <li class="mb-1">
            ...
            <li class="mb-1">
                ...
                <div class="collapse show" id="orders-collapse">
                    <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                        <li><a href="{{route('admin.news.create')}}" class="link-dark rounded">Add a News</a></li>
                        <li><a href="{{route('admin.news.drafts')}}" class="link-dark rounded">Release a Draft</a></li>
                        <li><a href="{{route('admin.news.index')}}" class="link-dark rounded">Manage News</a></li>
                    </ul>
                </div>
            </li>
            <li class="mb-1">
                ...
                <div class="collapse show" id="orders-collapse">
                    <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                        <li><a href="{{route('admin.comments.index')}}" class="link-dark rounded">Manage Comments</a></li>
                    </ul>
                </div>
            </li>
            ...
            <li class="mb-1">
                ...
                <div class="collapse" id="account-collapse">
                    <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                        ...
                        <li><a href="{{route('signout')}}" class="link-dark rounded">Sign out</a></li>
                    </ul>
                </div>
            </li>
        </ul>
